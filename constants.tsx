export const SCRIPTS = [
  ...
  },
  {
    ...
    features: [
      {
        title: "עימוד מהיר",
        description: "אופטימיזציה מלאה המונעת צווארי בקבוק."
      }
    ],
    steps: [
      "התקן את הסקריפט.",
...
export const TORAH_COVER_DESIGNS = [
  {
    ...
    name: "אפרים: כריכה תורנית",
    description: "אפרים: קובץ eps לעריכה מלאה באילוסטרייטור ",
    ...
    features: [],
    videoUrl: "",
    downloadUrl: "https://drive.google.com/file/d/1N6-gOHb27g4o4H4fl5QC5liB3uvUUTtx/view?usp=sharing",
    pdfPreviewUrl: "",
  },
];
...
export const FAQ = [
  { 
    ...
    "answer": "מעתיקים את הקובץ לתיקיית Scripts Panel באינדיזיין." 
  }
];