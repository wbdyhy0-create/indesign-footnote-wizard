export const SCRIPTS = [
  {
    ...
    "faqs": [
      { "question": "איך אני מגדיר מספור בגימטריה להערות?", "answer": "בלשונית 'מספור', בחר באופציה 'עברית - א, ב, ג'. המערכת תמיר אוטומטית את הערות הסיום למספור יהודי תקני." },
      { "question": "האם ניתן להוסיף קו מפריד מעל הכותרת של ההערות?", "answer": "כן. בלשונית 'כותרת ומפרידים' ניתן לבחור אובייקט מהעמוד שישמש כקו מפריד, ולהגדיר לו אורך, עובי ויישור." }
    ],
    "videoUrl": "https://www.youtube.com/embed/NdKZwgFfrTA",
    "price": "₪550",
    "originalPrice": "₪750",
    "color": "emerald",
  ...
  },
  {
    ...
    "fullDesc": "סקריפט עוצמתי המשלב 5 לשוניות עבודה: עבודה עם ייבוא קבצים מוורד. ניהול סגנונות, חיפוש והחלפה ממוקדים, מחיקת רווחים ואינטרים, ועוד אופציות עזר.",
    "features": [
    ...
    "faqs": [
      { "question": "איך אני מנקה רווחים כפולים?", "answer": "בלשונית 'כלים וניקוי', לחץ על הכפתור 'צמצם רווחים כפולים לרווח אחד'." }
    ],
    "videoUrl": "https://www.youtube.com/embed/X5gDKRbbOJ8",
    "price": "₪350",
    "originalPrice": "₪550",
    "color": "blue",
  ...
  },
  {
    ...
    "fullDesc": "המדריך המקצועי לוקח אותך צעד אחר צעד אל עולם הדיגיטל המתקדם.",
    "features": [
  ...
  },
  {
    ...
    "name": "אשף הערות שוליים הקצר",
    "shortDesc": "סקריפט מקצועי לעימוד והמרת הערות שוליים וסיום בשיא המהירות.",
    "fullDesc": "הפתרון המתקדם ביותר למעמדים באינדיזיין לניהול הערות שוליים.",
    "features": [
  ...
  {
    "id": "1771878514606",
    "name": "הבלטת תיבה פותחת",
    "shortDesc": "חוסך את המאמץ הסיזיפי של הבלטת תיבה פותחת.",
    "fullDesc": "סקריפט \"עיצוב מילה ראשונה Pro\" מבית \"נזר יוסף\" משנה את כללי המשחק.",
    "features": [],
    "steps": [],
    "faqs": [],
    "videoUrl": "https://www.youtube.com/embed/OnNoyUeNWtM",
    "price": "150 ש\"ח",
    "originalPrice": "250 ש\"ח",
    "color": "blue",
...
export const FAQ = [
  {
    ...
    "answer": "ההתקנה פשוטה מאוד: מעתיקים את קובץ הסקריפט לתיקיית Scripts Panel בתוך תיקיית התוכנה של אינדיזיין."
  },
  {
    "question": "האם יש תמיכה טכנית לאחר הרכישה?",
    "answer": "בהחלט. אנחנו מספקים תמיכה מלאה בוואטסאפ או במייל לכל בעיה או שאלה."
  }
];
