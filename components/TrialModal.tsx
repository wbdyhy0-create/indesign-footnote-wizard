        ...
        <div className="bg-[#0f172a] border border-slate-700 w-full max-w-md rounded-[2.5rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            <div className="flex justify-between items-start mb-6">
              <button onClick={onClose} className="text-slate-500 hover:text-white transition-colors bg-slate-800/50 p-2 rounded-xl">
            ...
            {step === 'success' && (
              <div className="text-center py-6 animate-fadeIn" dir="rtl">
                ...
                <div className="p-4 bg-slate-800/50 rounded-2xl border border-slate-700 text-right">
                  <a href={script.trialDownloadUrl} target="_blank" rel="noopener noreferrer" className="text-amber-500 text-xs font-bold hover:underline flex items-center gap-2">
